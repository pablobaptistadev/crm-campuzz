...
Estado em 13/09/2026. 127 testes de unidade passando, typecheck limpo, e a suíte
...
| Stream que abre e fica calado | Pior que o 500: o front liga `sseEventStreamReadyState` no **primeiro evento**, e os efeitos que registram query esperam por ela — o app inteiro ficava no esqueleto |
| `addQueryToEventStream` / `removeQueryFromEventStream` ausentes | Com o stream pronto, o front registra cada query nele: 400 em toda tabela aberta |
